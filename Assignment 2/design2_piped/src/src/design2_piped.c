...
DECLARE_FIFO(u8, 8388608, 5, 1)
DECLARE_FIFO(u8, 8388608, 6, 1)
...
fifo_u8_t *Approx_input_flag = &fifo_4;
fifo_u8_t *Duplicate_send_flag = &fifo_4;

fifo_u8_t *Abs_Diff_Abs_diff = &fifo_5;
fifo_u8_t *Sum_Abs_diff = &fifo_5;

fifo_u8_t *Sum_Sad_vals = &fifo_6;
fifo_u32_t *Printer_Sad_vals = &fifo_6;
...
connection_t connection_Duplicate_send_flag = {&Approx, &Duplicate, 0, 0};
...
connection_t *connections[] = {
	...
	&connection_Duplicate_send_flag
};

/////////////////////////////////////////////////
// Declaration of the network
network_t network = {".design2_piped", actors, connections, 6, 7};
