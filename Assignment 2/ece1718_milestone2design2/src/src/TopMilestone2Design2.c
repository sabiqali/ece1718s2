...
/////////////////////////////////////////////////
// FIFO allocation
DECLARE_FIFO(u8, 4194304, 0, 1)
DECLARE_FIFO(u8, 4194304, 1, 1)
DECLARE_FIFO(u8, 4194304, 2, 1)
DECLARE_FIFO(u8, 4194304, 3, 1)
DECLARE_FIFO(u8, 4194304, 4, 1)
DECLARE_FIFO(u8, 4194304, 5, 1)
...
network_t network = {".TopMilestone2Design2", actors, connections, 6, 6};
